...
public class GameServer {
    ...
    private GameServer() {
        ...
        pathConfig = new File("C:\\Users\\alksk\\IdeaProjects\\java4-main\\com\\config.txt");
        pathWorld = new File("C:\\Users\\alksk\\IdeaProjects\\java4-main\\com\\world.txt");
    ...
    private void loadWorld() throws IOException, ClassNotFoundException, SQLException {
        try {
            ...
            if (serverWorld == null){
                ...
                for (Entity e : serverWorld.getEntities()) {
                    if (e instanceof EntityPlayer){
                        DatabaseUtils.insertEntityPlayer((EntityPlayer)e);
                    } else {
