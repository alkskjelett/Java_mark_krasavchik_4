...
public class DatabaseUtils {
    ...
    public static void insertBattle_logs(Entity entity, Entity entity_death) throws SQLException {
        try (Connection c = GameServer.getConnection()){
            String sql = "INSERT INTO battle_logs VALUES(DEFAULT, ?, ?, ?)";
            PreparedStatement ps = c.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
            ps.setLong(1, entity_death.getId());
            ps.setLong(2, entity.getId());
            ps.setTimestamp(3, new Timestamp(entity_death.getDate_death().getTime()));
